...
- Ground every insertion in an official company page, government page, credible business listing, or supplied event article. Keep each insertion short, natural, and free of URLs. Preserve proper-name capitalization. Proofread the assembled sentence for grammar only; include articles in singular noun phrases ("a 255-room hotel"), preserving facts, numbers, tone, and the call to action. Repair grammar rather than rejecting a lead.
